...
If the `pages` parameter is set to `NULL`, all matching results from the Petfinder database will be extracted. The `pages` parameter defaults to `1`, therefore it must be explictly set to `NULL`.
